...
const navItems: NavItem[] = [
  ...
  { labelTr: "Lojistik", labelEn: "Logistics", href: "/panel/logistics", icon: Truck, roles: ["OWNER", "ADMIN", "SALES"], group: "Sales" },
  { labelTr: "Kurye Paneli", labelEn: "Courier", href: "/panel/courier", icon: Navigation, roles: ["OWNER", "ADMIN", "SALES"], group: "Main" },
