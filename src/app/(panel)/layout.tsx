...
const NAV_ITEMS = [
  { href: "/panel/dashboard", icon: LayoutDashboard, label: "Dashboard", roles: ["OWNER", "ADMIN", "SALES", "VIEWER"] },
  { href: "/panel/appointments", icon: Calendar, label: "Appointments", roles: ["OWNER", "ADMIN", "SALES", "VIEWER"] },
  { href: "/panel/leads", icon: Users, label: "Leads", roles: ["OWNER", "ADMIN", "SALES", "VIEWER"] },
  { href: "/panel/sales", icon: ShoppingBag, label: "Sales", roles: ["OWNER", "ADMIN", "SALES"] },
  { href: "/panel/inventory", icon: Package, label: "Inventory", roles: ["OWNER", "ADMIN"] },
  { href: "/panel/team", icon: UserCircle, label: "Team", roles: ["OWNER"] },
  { href: "/panel/mail", icon: Mail, label: "Mail Center", roles: ["OWNER", "ADMIN", "SALES"] },
  { href: "/panel/calendar", icon: ClipboardList, label: "Calendar", roles: ["OWNER", "ADMIN", "SALES"] },
  { href: "/panel/logs", icon: ScrollText, label: "Audit Logs", roles: ["OWNER", "ADMIN"] },
];
        ...
        <header className="h-16 border-b border-slate/30 flex items-center justify-between px-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-sm font-medium tracking-wider uppercase text-mist">
              {filteredNav.find((n) => pathname.startsWith(n.href))?.label || "Panel"}
            </h1>
          </div>
